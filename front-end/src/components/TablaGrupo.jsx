export default function TablaGrupo({ grupo }) {
  return (
    <div className='col-span-6 m-4 grid w-3/4 items-stretch rounded  border border-white text-sm'>
      <h2 className='self-start border-b border-white p-1 text-center'>
        {grupo.group}
      </h2>
      <table>
        <thead>
